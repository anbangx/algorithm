...
public class MinimumPathSum {
    ...
    //        if (grid[0].length == 0)
    //            return 0;
    //        int[][] rightGrid = removeColumn(grid, 0);
    //        int minRight = minPathSum(rightGrid);
    //        int[][] downGrid = removeRow(grid, 0);
    //        int minDown = minPathSum(downGrid);
    //        return (minRight < minDown ? minRight : minDown) + grid[0][0];
    //    }
